...
JJSimpleString addUnicodeEscapes(const JJString& str);
  ...
  class PommeLexer;
  class ErrorHandler {
    friend class PommeLexerTokenManager;
    friend class PommeLexer;
    protected:
      int error_count;
    public:
      ...
      virtual void handleUnexpectedToken(int expectedKind, const JJString& expectedToken, Token *actual, PommeLexer *parser) {
        error_count++;
      ...
      virtual void handleParseError(Token *last, Token *unexpected, const JJSimpleString& production, PommeLexer *parser) {
        error_count++;
      ...
      virtual void handleOtherError(const JJString& message, PommeLexer *parser) {
  ...
  class TokenManagerErrorHandler {
    ...
    public:
       ...
       //
       virtual void lexicalError(bool EOFSeen, int lexState, int errorLine, int errorColumn, const JJString& errorAfter, JJChar curChar, PommeLexerTokenManager* token_manager) {
       ...
       virtual void lexicalError(const JJString& errorMessage, PommeLexerTokenManager* token_manager) {
...
/* JavaCC - OriginalChecksum=a0040c76f89929fbeb057dc14eae3c67 (do not edit this line) */
