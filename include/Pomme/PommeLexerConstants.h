...
const  int BRACER = 40;
  /** RegularExpression Id. */
const  int BRACKETL = 41;
  /** RegularExpression Id. */
const  int BRACKETR = 42;
  /** RegularExpression Id. */
const  int COLON = 43;
  /** RegularExpression Id. */
const  int SEMICOLON = 44;
  /** RegularExpression Id. */
const  int COMMA = 45;
  /** RegularExpression Id. */
const  int POINT = 46;
  /** RegularExpression Id. */
const  int EXCLAMATION = 47;
  /** RegularExpression Id. */
const  int TILDE = 48;
  /** RegularExpression Id. */
const  int EQ = 49;
...
const  int PUBLIC = 63;
  /** RegularExpression Id. */
const  int PRIVATE = 64;
  /** RegularExpression Id. */
const  int PROTECTED = 65;
  /** RegularExpression Id. */
const  int OVERRIDE = 66;
  /** RegularExpression Id. */
const  int TRUE = 67;
  /** RegularExpression Id. */
const  int FALSE = 68;
  /** RegularExpression Id. */
const  int NULLEXP = 69;
  /** RegularExpression Id. */
const  int NEWEXP = 70;
  /** RegularExpression Id. */
const  int DELETEEXP = 71;
  /** RegularExpression Id. */
const  int INT = 72;
  /** RegularExpression Id. */
const  int IDENTIFIEROPERATOR = 73;
  /** RegularExpression Id. */
...
{0x22, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x22, 0};
