...
{
	TEST_PARSER_FILE("Test glob() { return new Test() ; }; class Test{ int64_t b = 8; Test t = new Test(); }; void main(){ Test t = new Test(); int64_t a = t.b; int64_t c = t.t.b; t.operator+=(); t.operator*(); t.operatorbool(); t.operator++(); t.t.salut(); t.salut().a; glob().t; };\n", "tests/AccesMember.txt");
}
